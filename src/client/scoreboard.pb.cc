...
void protobuf_AssignDesc_scoreboard_2eproto() {
  ...
  static const int Message_offsets_[5] = {
    ...
    PROTO2_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET(Message_default_oneof_instance_, unfreeze_),
  ...
  static const int Event_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Event, contesttime_),
...
void protobuf_AddDesc_scoreboard_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\020scoreboard.proto\022\004wire\"\204\001\n\007Message\022\034\n\005"
    "event\030\001 \001(\0132\013.wire.EventH\000\022#\n\005setup\030\002 \001("
    "\0132\022.wire.ContestSetupH\000\022\023\n\tHeartBeat\030\003 \001"
...
const int Message::kUnfreezeFieldNumber;
#endif  // !_MSC_VER
...
void Message::InitAsDefaultInstance() {
  ...
  Message_default_oneof_instance_->unfreeze_ = false;
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_unfreeze;
        break;
      }
...
void Message::SerializeWithCachedSizes(
  ...
  // optional bool unfreeze = 4;
  if (has_unfreeze()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(4, this->unfreeze(), output);
  }
...
::google::protobuf::uint8* Message::SerializeWithCachedSizesToArray(
  ...
  // optional bool unfreeze = 4;
  if (has_unfreeze()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(4, this->unfreeze(), target);
  }
...
const int Event::kContestTimeFieldNumber;
...
void Event::MergeFrom(const Event& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_contesttime()) {
      set_contesttime(from.contesttime());
    }
    if (from.has_state()) {
...
void Event::Swap(Event* other) {
  if (other != this) {
    ...
    std::swap(contesttime_, other->contesttime_);
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<ContestSetup*>(16)->f) - \
   reinterpret_cast<char*>(16))
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_SimulatedStart;
        break;
      }
      ...
      case 6: {
        if (tag == 48) {
         parse_SimulatedStart:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::int64, ::google::protobuf::internal::WireFormatLite::TYPE_INT64>(
                 input, &simulatedstart_)));
          set_has_simulatedstart();
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(57)) goto parse_SimulationSpeed;
        break;
      }
      ...
      case 7: {
        if (tag == 57) {
         parse_SimulationSpeed:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   double, ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE>(
                 input, &simulationspeed_)));
...
void ContestSetup::SerializeWithCachedSizes(
  ...
  // optional int64 SimulatedStart = 6;
  if (has_simulatedstart()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(6, this->simulatedstart(), output);
  }

  // optional double SimulationSpeed = 7;
  if (has_simulationspeed()) {
...
::google::protobuf::uint8* ContestSetup::SerializeWithCachedSizesToArray(
  ...
  // optional int64 SimulatedStart = 6;
  if (has_simulatedstart()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(6, this->simulatedstart(), target);
  }
...
void ContestSetup::MergeFrom(const ContestSetup& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_simulatedstart()) {
      set_simulatedstart(from.simulatedstart());
    }
    if (from.has_simulationspeed()) {
      set_simulationspeed(from.simulationspeed());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
